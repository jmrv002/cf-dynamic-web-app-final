...
p2 = Product.create(name: "Drone", description: productDescription, image_url: "https://i.imgur.com/L0tyRBB.png",colour: 'white' ,price: 400.00)
p3 = Product.create(name: "Camara Lumix", description: productDescription, image_url: "https://imgur.com/rXT8tnB.png",colour: 'white' ,price: 200.00)
p4 = Product.create(name: "PS4", description: productDescription, image_url: "https://imgur.com/iOQ4yjY.png",colour: 'white' ,price: 250.00)
